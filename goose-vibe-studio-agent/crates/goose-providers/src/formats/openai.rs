...
/// Deserialize tool-call `arguments` from either a JSON string or an inline
/// JSON object/array. Some providers (e.g. Ollama-served gpt-oss models)
/// return the arguments as a JSON object rather than a JSON-encoded string.
